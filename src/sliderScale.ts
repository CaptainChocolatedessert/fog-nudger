 ...
 *
 * Two controls store graph units — the map's longer side is 1, the unit that outlives the raster,
 * which is what a value re-applied on every derive has to do — and no spelling of that is a number
 * anybody can hold on to (user, 2026-09-07: *"an
