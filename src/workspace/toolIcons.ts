  ...
  */
  /*
    ...
    **Inherited from the tool it replaced** (user, 2026-09-22: *"it should adopt the name and glyph from
    ...
    not ink* — only what answers it. Two lumps rather than one path with a hole, because even-odd is a
    symmetric difference and the parts of the capsule outside the blot would have filled solid instead
    of cutting.

    **The scatter drawn for it hours earlier is gone**: four candidates and then three scatters were
    judged at strip size, and then the tool grew into its neighbour's job before either had been in two
    rooms. Keeping both would have been the same picture twice.
  */
  speckles:
